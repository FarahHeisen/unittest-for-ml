...
class TestDataFrame(unittest.TestCase):
    ...
    def test_delete_columns_return_df_without_deleted_columns(self):
        # Given
    ...
    def test_fill_empty_numerical_values_return_df_filled_with_mean_for_numerical_values(self):
        # Given
    ...
    def test_fill_empty_categorical_values_return_df_filled_with_most_occurence_for_categorical_values(self):
        # Given
    ...
    def test_fill_empty_value_for_categorical_and_numeric_return_df_filled(self):
        # Given
        input_df = pd.DataFrame({"age": [16.0, None, 0.0, None], "taille": [120, None, 140, None],
    ...
    def test_one_hot_encode_correctly_dummifies_a_one_column_category_df(self):
        # Given
    ...
    def test_process_return_processed_dataframe(self):
        # Given
    ...
    def test_process_call_functions_in_the_right_order(self, one_hot_mock, fill_empty_values_mock,
                                                       delete_columns_mock
                                                       ):
        # Given
